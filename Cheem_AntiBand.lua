-- Cheem Hub Anti-Leak (Free)
-- Do not edit or leak

local checksum = "24137"
local raw = [[--====================== CHEEM HUB | ALL IN ONE ======================--
...
if #raw ~= tonumber(checksum) then
    game:GetService("Players").LocalPlayer:Kick("Cheem Hub | Anti-Leak")
    return
end

local f = loadstring(raw)
if not f then
    game:GetService("Players").LocalPlayer:Kick("Cheem Hub | Corrupted")
    return
end
